...
from sandbox_ai_tutorial.pkg_globals import PACKAGE_ROOT
...
class ComposeConfiguration:
    ...
    def _add_sandbox_ai_tutorial_latex(self):
    ...
    def _add_sandbox_ai_tutorial_mongo(self):
    ...
    def _mongo_sandbox_ai_tutorial_create_user_js(self):
    ...
    def _add_sandbox_ai_tutorial_nginx(self):
    ...
    def _add_sandbox_ai_tutorial_postgres(self):
    ...
    def _add_sandbox_ai_tutorial_pgadmin(self):
    ...
    def _add_sandbox_ai_tutorial_streamlit(self):
        ...
        self._config['services'][f'{PROJECT_NAME}_streamlit'] = {
            ...
            'volumes': [
                ...
                f'/usr/src/sandbox_ai_tutorial/applications/streamlit',
            ],
        }
