...
with open('sandbox_ai_tutorial/__init__.py', 'r') as fd:
...
setup(
    ...
    package_dir={'sandbox_ai_tutorial': 'sandbox_ai_tutorial'},
    include_package_data=True,
    entry_points={'console_scripts': [
        'count=sandbox_ai_tutorial.cli:count',
    ]})
